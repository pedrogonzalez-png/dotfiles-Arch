...
-- Tela de Tempo de Jogo (SUPER + A)
hl.bind("SUPER + A", hl.dsp.exec_cmd("bash '/home/Pedro/Downloads/coisas do vscode/contador de horas/toggle_menu.sh'"))

-- Atalho para o BTOP
hl.bind("SUPER + ALT + V", hl.dsp.exec_cmd("kitty -e btop"))

hl.bind("ALT + F10", hl.dsp.exec_cmd("killall -SIGUSR1 gpu-screen-recorder"), { description = "Recorder: Save replay" })

hl.bind("SUPER + ALT + Up", hl.dsp.exec_cmd("pkill rofi || rofi -show drun -theme /home/Pedro/.config/rofi/dashboard.rasi"))
hl.bind("SUPER + SUPER_L", hl.dsp.exec_cmd("pkill rofi || rofi -show drun"))
hl.bind("SUPER + SUPER_R", hl.dsp.exec_cmd("pkill rofi || rofi -show drun"))
